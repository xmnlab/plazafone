...
/**
 * EstruturaPersistenciaXaman: Classe Controladora do Tempo
 * 
 * A interface EstruturaPersistenciaXaman tem como objetivo
 * for�ar a estrutura b�sica de classes de persist�ncia
 * 
 * @license    http://www.gnu.org/licenses    GNU License
 * @copyright  Copyright (C) 2008  Ivan Ogassavara
 * @category   persistencia
