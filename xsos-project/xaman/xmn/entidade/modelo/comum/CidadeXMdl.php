...
/** UfXMdl */ 
include_once $XAMAN . 'modelo/comum/UfXMdl.php';

/** ZonaXMdl */ 
include_once $XAMAN . 'modelo/comum/ZonaXMdl.php';

/**
 * CidadeXMdl: Classe modelo para armazenar cidade
 * 
 * @license    http://www.gnu.org/licenses    GNU License
 * @copyright  Copyright (C) 2008  Ivan Ogassavara
 * @category   modelo
 ...
 * @access     public
 */
class CidadeXMdl extends ModeloXmn
{
    private $ufXMdl;
    private $zonaXMdl;
    ...
    {
        $this->ufXMdl   = new UfXMdl();
        $this->zonaXMdl = new ZonaXMdl();
    }

    public function &pegaUfXMdl()
    {
        return $this->ufXMdl;
    }
    ...
    public function atribuiUfXMdl(UfXMdl $ufXMdl)
    {
        $this->ufXMdl = $ufXMdl;
    }
